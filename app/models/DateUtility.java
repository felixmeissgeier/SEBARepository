...
public class DateUtility {
	...
	return new Period(date1, date2, PeriodType.forFields(new DurationFieldType[] { DurationFieldType.minutes() }))
		.getMinutes();
    }
	...
	return new Period(date1, date2, PeriodType.forFields(new DurationFieldType[] { DurationFieldType.days() }))
		.getDays();
    }
