...
public class Security extends Secure.Security {
	...
	/**
	 * Session key to identify an authenticated user. Used to keep 
	 * the used logged in right after account creation.
	 */
	 ...
	 * 
	 * @param email Email of the user used as unique identifier
	 * @param password User password from the authentication request
	...
	/**
	 * Handles requests to the sign-up page. Renders the sign-up form if requested
	 * with empty parameters or validates the data and creates a new user of the 
	 * sign-up form was submitted.
	 *  
	 * @param name Human readable name of the user
	 * @param email Email of the user; used as user identifier
	 * @param password User password
	 * @param question Security question
	 * @param answer Answer to the security question
	 * @param captchaId Id of the captcha
	 * @param captcha Submitted captcha value
	 */
     ...
     * 
     * @param password Password to calculate the hash
     ...
     * 
     * @param s String to calculate the hash
     * @return Hash value
     */
